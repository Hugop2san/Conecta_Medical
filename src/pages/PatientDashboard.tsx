    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-6 border-l-4 border-l-primary">
          ...
          <h3 className="text-lg font-bold mb-1">Dr. Ricardo Silva</h3>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <section>
            ...
            <div className="card divide-y divide-slate-100">
              {[
                ...
                { title: 'Consulta Confirmada', desc: 'Dr. Ricardo Silva aceitou seu agendamento', time: 'Há 5 horas', icon: Calendar, color: 'text-secondary' },
                { title: 'Pagamento Escrow', desc: 'R$ 250,00 retidos para consulta de amanhã', time: 'Ontem', icon: ShieldCheck, color: 'text-yellow-600' }
              ].map((item, i) => (
        ...
        <div className="space-y-8">
          ...
          <div className="card p-6 border-2 border-primary/20 bg-primary/5">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="text-2xl font-bold text-primary">R$ 49,90<span className="text-xs text-slate-400">/mês</span></div>
            </div>
